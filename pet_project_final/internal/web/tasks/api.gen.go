...
type ServerInterface interface {
	...
	// Create a new task OR filter by userID
	// (POST /tasks)
...
type PostTasks404Response struct {
}

func (response PostTasks404Response) VisitPostTasksResponse(w http.ResponseWriter) error {
	w.WriteHeader(404)
	return nil
}
